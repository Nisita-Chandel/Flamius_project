      ...
      <section className="px-6 pb-28">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 shadow-2xl
                          transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(240,177,0,0.15)]">

            {/* Header */}
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#f0b100] to-[#8a6415]
            ...
            <button
              ...
              className="w-full bg-[#f0b100] text-black py-4 rounded-xl font-semibold
                         flex items-center justify-center gap-3
                         transition-all duration-300
                         hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(240,177,0,0.4)]
                         active:scale-95">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-6 flex gap-4
                              ...
                              hover:-translate-y-1 hover:border-[#b08a2e]

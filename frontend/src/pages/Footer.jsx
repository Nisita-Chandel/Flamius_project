      ...
      <div className="text-center mt-16 px-6">
        ...
        <div className="flex justify-center gap-4 max-w-md mx-auto">
          <input
            ...
            className="w-full px-4 py-3 rounded-lg bg-neutral-900 border border-yellow-500/20 focus:outline-none"
          />
          <button className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-6 py-3 rounded-lg font-semibold">
            SUBSCRIBE
          </button>
        </div>
      </div>
